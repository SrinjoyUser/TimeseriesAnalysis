# Using Toggle Buttons to Switch Between Project Layers (Phase 1: Macro Trends, Phase 2: AI Customer Segmentation)
# This is the main Streamlit app that combines both phases into one seamless dashboard with toggle buttons
...
# --- 1. CENTERED TOP NAVIGATION (The Toggle Switch) ---
# We use a segmented control for a modern "Toggle" feel at the very top
st.markdown("<h1 style='text-align: center;'>Fintech Analytics Suite</h1>", unsafe_allow_html=True)

# This creates a pill-shaped toggle in the center of the page
page = st.segmented_control(
    "Select Project View:", 
    options=["Macro-Economic Trends", "AI Customer Segmentation"], 
    default="Macro-Economic Trends",
